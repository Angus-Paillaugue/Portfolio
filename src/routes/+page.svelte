...
<nav class="bg-white fixed w-full z-50 top-0 left-0 border-b border-gray-200 bg-opacity-50 backdrop-blur-md h-16 transition-all">
    <div class="flex flex-row justify-center sm:justify-between mx-auto max-w-4xl items-center h-full px-2 gap-2">
        ...
        <div class="flex flex-col-reverse mx-auto md:gap-20 gap-5 md:flex-row justify-center items-start md:w-full max-w-sm md:max-w-none">
            <div class="block md:w-3/5 w-full text-start h-full">
                ...
                <div class="flex flex-row gap-6 mt-10 max-md:justify-center items-center w-full">
                    ...
                    <a href="{socials.filter(el => el.name === "LinkedIn")[0].link}" target="_blank" class="group">
