...
<nav class="bg-white fixed w-full z-50 top-0 left-0 border-b border-gray-200">
    <div class="flex flex-row justify-center md:justify-between mx-auto max-w-4xl p-4 items-center">
        <h3 class="max-md:text-xl max-sm:hidden">Angus</h3>
        <div class="flex justify-center md:justify-between flex-row md:gap-8 gap-4 font-medium border-gray-100 rounded-lg bg-white md:text-base relative h-fit">
